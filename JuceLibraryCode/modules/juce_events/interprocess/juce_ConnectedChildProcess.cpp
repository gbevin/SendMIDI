...
{
    StringArray args;
    return launchSlaveProcess (executable, commandLineUniqueID, args, timeoutMs, streamFlags);
}

bool ChildProcessMaster::launchSlaveProcess (const File& executable, const String& commandLineUniqueID, const StringArray& additionalArgs, int timeoutMs, int streamFlags)
{
    connection = nullptr;
